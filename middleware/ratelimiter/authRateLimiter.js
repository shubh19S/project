...
const  AUTH_WINDOWS_MS = 15 * 60 * 1000 // 15 minutes in milliseconds
...
const registerAccountSlowDownRateLimiter = (isEnable = true) => isEnable ? slowDown({
...
module.exports = {
    authRateLimiter,
    registerAccountSlowDownRateLimiter
}